...
class DebugManager {
    ...
    static CHAPTER1_GROUPS = [
        ...
        { label: '🏞  溪流山谷', ids: ['EVT_VALLEY_ENTRY','EVT_YINCHEN_ZONE','EVT_YINCHEN_DONE','EVT_STONE_BRIDGE','EVT_FOG_ZONE','EVT_HIDDEN_HERB','EVT_GUGEN_DISCOVERY','EVT_GUGEN_EXAMINE','EVT_RETURN_VILLAGE'] }
    ];
