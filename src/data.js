...
const GameData = {
    ...
    HERBS_DATA: [
        ...
        { id: 'heshouwu', name: '何首乌', property: '苦甘涩/微温', meridian: '肝肾', effect: '补肝肾，益精血，乌须发，强筋骨', icon: '🌰', rarity: 'rare', rarityLabel: '稀有', category: '根茎类', season: '秋冬采挖', origin: '南方深山老林', petTip: '⭐ 乌发圣品！百年首乌有传说之力', symptom: '血虚证', image: '', descDetail: '何首乌为蓼科植物的块根，以唐代何姓老者食之白发转乌而得名。制用补肝肾、益精血，生用润肠通便。传百年首乌成人形，为仙家之品。' },
        { id: 'hongjingtian', name: '红景天', property: '甘苦/平', meridian: '肺心', effect: '益气活血，通脉平喘，清肺止咳', icon: '🌺', rarity: 'rare', rarityLabel: '稀有', category: '根茎类', season: '秋季采挖', origin: '青藏高原雪山', petTip: '⭐ 高原仙草！抗缺氧缓疲劳', symptom: '气虚证', image: '', descDetail: '红景天生于高寒地带，素有"高原人参"之美誉。能抗缺氧、抗疲劳、活血益气，为藏医药中常用的珍品药材。' },
